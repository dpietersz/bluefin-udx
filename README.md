...
- **GUI apps**: Microsoft Teams (with Wayland screen-share patch), Telegram Desktop, Chromium + Browserpass, Zen Browser, Helium, Beekeeper Studio, Zed editor, Proton Authenticator, Proton Mail
